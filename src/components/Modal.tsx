...
function Modal({ children, containerClassName, onBgClick, backgroundClassName }: ModalPropsType) {
  ...
  let modal = (
    <div onClick={onBgClick} id="modal-background" className={`fixed top-0 left-0 grid content-center w-screen h-screen justify-center bg-black bg-opacity-20 backdrop-blur-sm ${backgroundClassName}`}>
