...
function ScheduleCard({ weekDay, scheduleItems, className }: { weekDay: String; scheduleItems: String[]; className?: String }) {
  return (
    <div className={`flex flex-col bg-caramel_brown min-w-[200px] h-[250px] justify-self-center lg:min-w-[250px] lg:h-[300px] ${className || ""}`}>
...
function Schedule() {
  return (
    <section className="mt-36">
      ...
      <div className="grid grid-cols-2 gap-5 lg:grid-cols-3 w-fit justify-items-center items-center justify-center content-center place-items-center">
        <ScheduleCard
