...
function AboutUs() {
  return (
    <section className="flex flex-col lg:flex-row m-2 p-4 lg:space-x-8 space-y-4 h-fit min-w[300px] w-[70vw] max-w-[900px]">
      ...
      <article className="flex flex-col justify-center text-sm">
        ...
        <div className="bg-navbar_background bg-caramel_brown p-6 rounded-sm text-crate_brown">
