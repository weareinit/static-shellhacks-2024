  ...
  return (
    <section className="m-2 p-4 h-fit min-w[300px] w-[70vw] max-w-[900px]">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-stretch space-x-5">
        ...
        <article className="flex flex-1 flex-col justify-center text-sm mb-2">
          <div className="bg-navbar_background bg-caramel_brown p-6 rounded-sm text-crate_brown h-full">
            ...
            <p className="">
              Explore the world of technology through our workshop tracks. Work together with fellow students and mentors to{" "}
              <span className="font-extrabold inline-block">build exciting projects</span>. Meet recruiters and <span className="font-extrabold inline-block">land internships</span> and job
              opportunities. <span className="font-extrabold inline-block">Win amazing prizes</span>, get tons of cool swag, and more - all at ShellHacks!
            </p>
          </div>
        </article>
      </div>
