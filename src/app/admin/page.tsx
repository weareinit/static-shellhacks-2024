...
const AdminDashboard = async () => {
  ...
  if (!sess?.user) {
    ...
    return <p>Not admin. If you recently recieved the role, log out and log in again.</p>;
  }
      ...
      <div className="relative flex justify-center p-2 md:p-12">
        ...
        <div className="relative z-10 w-full">
          ...
          <div className="mb-10 grid w-full grid-cols-10 items-start text-center">
            ...
            <p className="col-span-10 mt-4 font-zoonaji text-4xl text-darker_cyan sm:col-span-8 md:text-5xl lg:text-6xl">Admin Dashboard</p>
          </div>
          <FilteredApplicantSearchView />
        </div>
      </div>
    </div>
  );
