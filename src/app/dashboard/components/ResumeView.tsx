    ...
    <div className="flex flex-col items-start gap-2">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div>
          ...
          <CustomButton onClick={() => fileInputRef.current?.click()} colorVariant={2}>
            {isUploadingResume ? (
              "Uploading..."
            ) : (
              <div className="flex items-center gap-2">
      ...
      {resumeUploadError && <p className="text-bold font-zoonaji text-red-500">Error: {resumeUploadError}</p>}
    </div>
  );
}
