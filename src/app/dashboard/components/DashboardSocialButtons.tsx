...
export default function DashboardSocialButtons() {
  return (
    <>
      <div className="col-span-full flex flex-row justify-center gap-3">
        <Link href="https://discord.com/invite/init" target="_blank">
          <SiDiscord
            size={40}
            className="fill-dark_brown transition ease-in-out hover:scale-125 hover:cursor-pointer hover:fill-pink"
          />
        </Link>
