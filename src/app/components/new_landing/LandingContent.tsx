  ...
  return (
    <>
      <div className="text-center">
        <p>The Largest Hackathon in the East Coast!</p>
        <div className="flex justify-center">
          <p>Powered By </p>
          <div className="relative bottom-1 right-3 h-8 w-28">
            <Image
        ...
        <p>September 27th - 29th, 2024</p>
        <p>FIU&apos;s Grahams Center - Miami, FL</p>
      ...
      <div className="flex justify-center mt-7">
        <div className="w-11 h-11 relative bottom-3">
          <Image
