      ...
      {(!session || !session.user.isRegistered) && (
        <div
          ...
          bg-reddish_grey pb-2 pt-4 text-center font-zoonaji text-2xl text-stone-50 no-underline transition-all duration-200
           ease-in-out hover:scale-105 xxs:h-[3rem] xxs:w-[8rem] xxs:rounded-[20px] xxs:text-[18px] xsm:h-[4rem] xsm:w-[10rem] xsm:rounded-[25px] xsm:text-[20px] md:h-[3rem] md:w-[12rem] md:text-xl lg:h-[4rem] lg:w-[15rem]
