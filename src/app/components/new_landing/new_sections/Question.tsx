    ...
    <div className="w-full">
      ...
      >
        <div className="flex w-full items-center justify-between bg-cotton_seed xxs:px-4 xxs:py-1 sm:px-4 sm:py-2 md:px-4 md:py-5 xlg:px-5 xlg:py-8 xxl:px-6 xxl:py-8">
          <h2 className="text-left font-museo xxs:py-2 xxs:text-[15px] xsm:text-[18px]  sm:text-[20px] md:text-[30px] xlg:text-[35px] xxl:text-[45px]">
            {Q}?
          </h2>
          <Image
            priority
        ...
        >
          <div className="bg-cotton_seed p-4 xlg:p-6 xxl:p-8">
            <h3 className="text-left font-museoregular xxs:text-[13px] xsm:text-base xlg:text-[1.5rem] xlg:leading-[30px] xxl:text-[2rem] xxl:leading-[40px]">
              {A}
            </h3>
          </div>
        </div>
