...
const PreviousNumbers = () => {
  return (
    ...
    <div className="relative z-10 flex flex-col  items-center justify-end gap-10 xxs:top-[-180px] xxs:mt-[18rem] xxs:gap-3 xsm:top-[-80px] xsm:mt-[10rem] xsm:gap-10 sm:mt-0 sm:gap-8">
      <p className="relative whitespace-nowrap font-museo text-2xl font-extrabold text-darker_cyan xxs:bottom-8 xsm:bottom-16 xsm:text-4xl sm:text-3xl md:text-5xl lg:text-6xl xlg:text-7xl xxl:top-[-250px]">
        Last Year&apos;s Numbers
      </p>
