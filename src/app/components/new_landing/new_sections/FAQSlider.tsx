...
const FAQSlider = () => {
  ...
  When and where is ShellHacks?ShellHacks takes place from September 27th through the 29th at the Graham Center, located at Florida International University's Modesto A. Maidique Campus in Miami, Florida.
  Is ShellHacks in-person or virtual?ShellHacks will be in person only this year due to MLH's guidance on event modality for events in the 2024-2025 hackathon season. We look forward to hosting you on-site for an exciting and immersive experience!
  How long is ShellHacks?ShellHacks is a 36-hour hackathon, beginning at 3pm on Friday and ending at 5pm on Sunday. Throughout this time, you can expect key events such as our opening and closing ceremonies, career fair, and judging, as well as a variety of workshops, activities, meals, and snacks. Hacking (project-building) time begins at 11pm on Friday and ends at 11am on Sunday. We encourage you to work on a project for as long as you can during this time!
  ...
  Will there be a place to sleep?The Graham Center will remain open for the entire event, and so will the classrooms, allowing you to sleep over and not miss any of the action! We encourage you to stay for as long as possible so that you have enough time to work on your project and take advantage of all the workshops, meals, activities, and more. We recommend bringing something to sleep on such as a sleeping bag, twin-sized air mattress, or inflatable pool floatie (yes we said pool floatie!). Don't forget to also bring essentials such as a laptop, charger, headphones, blanket, and toiletries to keep you refreshed over the weekend.
  ...
  How can I become a sponsor?Please reach out to our team at industry@weareinit.org and we'll get back to you promptly!
