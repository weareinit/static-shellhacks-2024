...
const SlideComponent: React.FC<SlideProps> = ({ title }) => {
    ...
    <div>
      ...
      <div className="h-full justify-center gap-6 xxs:flex xxs:flex-col xxs:gap-y-3 sm:grid sm:grid-cols-2 sm:gap-6 md:grid-cols-2 lg:grid-cols-5 xlg:gap-8 xxl:gap-10">
        <div className="pb-full relative xxs:mx-[40px] xxs:h-[200px] xsm:mx-[80px] sm:col-span-1 sm:mx-0 sm:h-full md:col-span-1 lg:col-span-2">
          <Image priority src={getAssetPath("images/hackers_pic.jpg")} objectFit="cover" layout="fill" alt="hackers" className="absolute left-0 top-0 h-full w-full rounded-lg" />
        </div>
        <div className="sm:col-span-1 md:col-span-1 lg:col-span-3">
          <h3 className=" font-museo text-[20px] text-white xxs:text-[13px] xsm:text-[15px] md:text-[18px] xlg:text-[25px] xxl:text-[30px]">
            Ready to immerse yourself in the ultimate tech experience? Join us for ShellHacks, Florida&apos;s Largest Hackathon! Over 1,200 students from across the state and around the world will
            come together to:
          </h3>
          <br />
  ...
  const ProjectsComponent = () => (
    <div>
      ...
      <div className="h-full justify-center gap-6 xxs:flex xxs:flex-col xxs:gap-y-3 sm:grid sm:grid-cols-2 sm:gap-6 md:grid-cols-2 md:gap-6 lg:grid-cols-5 lg:gap-8 xlg:gap-8 xxl:gap-10">
        <div className="pb-full relative xxs:mx-[40px] xxs:h-[200px] xsm:mx-[80px] sm:col-span-1  sm:mx-0 sm:h-full md:col-span-1 lg:col-span-2">
          <Image priority src={getAssetPath("images/hackers_pic_3.jpg")} objectFit="cover" layout="fill" alt="hackers" className="absolute left-0 top-0 h-full w-full rounded-lg" />
        </div>
        <div className="col-span-1 md:col-span-1 lg:col-span-3">
          ...
          <br />
          <h3 className="font-museo text-[20px] text-white  xxs:text-[13px] xsm:text-[15px] md:text-[18px]  xlg:text-[25px] xxl:text-[30px]">
            Build your project using any technology you like! Whether you&apos;re interested in web development, AI/ML, hardware, or anything in between, there&apos;s always something to create. As
            you work hard, you&apos;ll have the opportunity to showcase your creativity, problem-solving skills, and technical knowledge to top companies looking to hire talented students!
          </h3>
        </div>
      </div>
    </div>
  ...
  const WorkshopsComponent = () => (
    <div>
      ...
      <div className="h-full justify-center gap-6 xxs:flex xxs:flex-col sm:grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-5 xlg:gap-8 xxl:gap-10">
        <div className="pb-full relative xxs:mx-[40px] xxs:h-[200px] xsm:mx-[80px] sm:col-span-1 sm:mx-0 sm:h-full md:col-span-1 lg:col-span-2">
          <Image priority src={getAssetPath("images/peeps.jpg")} objectFit="cover" layout="fill" alt="hackers" className="absolute left-0 top-0 h-full w-full rounded-lg" />
        </div>
        <div className="sm:col-span-1 md:col-span-1 lg:col-span-3">
          <h3 className="font-museo text-[20px] text-white xxs:text-[13px] xsm:text-[15px] md:text-[18px] xlg:text-[25px] xxl:text-[30px]">
            ShellHacks offers a variety of workshop tracks to introduce you to the world of technology and careers in the field! These workshops are beginner friendly and open to all.
          </h3>
          <br />
  ...
  const CareerFairComponent = () => (
    <div>
      ...
      <div className="h-full justify-center gap-6 xxs:flex xxs:flex-col xxs:gap-y-3 sm:grid sm:grid-cols-2 sm:gap-6 md:grid-cols-2 lg:grid-cols-5  xlg:gap-8 xxl:gap-10">
        <div className="pb-full relative xxs:mx-[40px] xxs:h-[200px] xsm:mx-[80px] sm:col-span-1 sm:mx-0 sm:h-full md:col-span-1 lg:col-span-2">
          <Image priority src={getAssetPath("images/networking.jpg")} objectFit="cover" layout="fill" alt="hackers" className="absolute left-0 top-0 h-full w-full rounded-lg sm:px-0" />
        </div>
        <div className="col-span-1 md:col-span-1 lg:col-span-3">
          <h3 className="font-museo text-[20px] text-white xxs:text-[13px] xsm:text-[15px] md:text-[18px]  xlg:text-[25px] xxl:text-[30px]">
  ...
  return <div className="flex h-full w-full min-w-full items-start justify-center xxs:py-3 xsm:py-12">{renderComponent()}</div>;
};
