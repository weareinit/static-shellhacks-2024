  ...
  return (
    <div className="flex flex-col items-center justify-start">
      ...
      >
        {" "}
        <button
          className="bg-cotton_seed px-5 font-zoonaji text-[30px] text-english_walnut hover:bg-reddish_grey 
          xxs:rounded-[15px] xxs:px-2 xxs:pb-1 xxs:pt-1 xxs:text-[15px] 
          xsm:px-3 xsm:pb-1.5 xsm:pt-2 xsm:text-[18px] 
