      ...
      <div className="absolute inset-0 top-[600px] flex w-full flex-col items-center justify-start text-center xxs:top-[200px] sm:top-[250px] md:top-[400px]">
        ...
        <div>
          <iframe
            ...
            allowFullScreen
            className="z-100 mt-[50px] xxs:h-[200px] xxs:w-[300px] xsm:h-[300px] xsm:w-[450px] sm:h-[400px] sm:w-[600px] md:h-[400px] md:w-[600px] lg:h-[500px] lg:w-[900px] xlg:h-[600px] xlg:w-[1100px] xxl:h-[800px] xxl:w-[1400px]"
          ></iframe>
        </div>
