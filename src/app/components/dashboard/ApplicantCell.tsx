...
import type { AppStatusMutationType } from "@/app/hooks/ApplicationStatusMutation";
...
export default function ApplicantCell({
  ...
  const toggleResetDiscordVerification = async () => {
    await applicationUpdateMutation.mutateAsync({
      ...data,
      discord_id: null,
  ...
  return (
    <div className="rounded-pixel relative my-2 h-fit w-full bg-white p-3">
      <h3
        onClick={toggleItem}
        className="font-pixel decoration-blue grid grid-cols-9 text-lg font-bold hover:cursor-pointer"
      >
        ...
        <div className="col-span-1 flex items-center justify-between">
          <div
            ...
            style={{
              backgroundColor:
                APPLICATION_STATUS_COLOR_MAPPING[data.application_status!],
            }}
      ...
      {showItem && (
        <div className="grid grid-cols-8 items-center justify-between gap-3 px-2 py-4 md:px-4">
          <div className="col-span-8 lg:col-span-6">
            <ApplicantInfo
              data={isEditing ? editedCell : data}
