...
import { ethnicityOptions, genderOptions, levelsOfStudy, majorOptions, pronounOptions } from "@/util/RegistrationData"
      ...
      .test("fileType", "Unsupported File Format", (value) => {
        ...
        if (!file) {
          ...
          if (supportedFormats.includes(file.type)) {
            ...
            return new Yup.ValidationError("Unsupported File Format", value, "resume")
          }
        }
      }),
    discord: Yup.string(),
    ...
    >
      {(props: FormikProps<Values>) => (
        <Form className="grid gap-3 my-2">
          ...
          <SelectInput options={pronounOptions} label="Pronouns" name="pronouns" />
          {props.values.pronouns === "Other" && <TextInput label="Fill in your pronouns here" name="fill_in_pronouns" type="text" />}
          <SelectInput label="Ethnicity" name="ethnicity" options={ethnicityOptions} />
          ...
          <CheckboxInput
            label={
              <h2>
                ...
                (https://mlh.io/privacy). I further agree to the terms of both the MLH Contest Terms and Conditions (
